## FINAL downstream part 2 - reproduce manuscript Fig 3, Fig 4, Fig 5 on corrected fungal set.
...
tb <- file.path(out,"tables"); fg <- file.path(out,"figures")
...
try({
  ...
  r2 <- RsquareAdj(db); trm <- anova.cca(db,by="term",permutations=999)
